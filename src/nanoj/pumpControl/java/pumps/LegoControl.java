...
public class LegoControl extends Pump {
    ...
    public String connectToPump(String comPort) throws Exception {
        ...
        */
        ...
        connected = true;
        int[] sPumps = new int[]{Integer.parseInt(answer.substring(0, answer.indexOf("."))), Integer.parseInt(answer.substring(answer.indexOf(".") + 1/*,answer.length()-1*/))};
    ...
    public void setTargetVolume(double target) {
        targetVolume = target;
    } //Target volume should be given in ul
